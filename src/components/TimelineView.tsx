...
export default function TimelineView({ days, onSelectDay }: Props) {
  if (days.length === 0) {
    return (
      <div className="animate-rise flex flex-col items-center justify-center rounded-2xl border border-dashed border-line bg-white/40 px-6 py-12 text-center dark:bg-white/5">
