  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={4}
        className="surface surface-ring w-full resize-none rounded-2xl p-4 text-[15px] leading-relaxed text-ink shadow-sm outline-none transition placeholder:text-ink-faint focus:ring-2 focus:ring-brand/30"
      />
    </div>
  );
}
